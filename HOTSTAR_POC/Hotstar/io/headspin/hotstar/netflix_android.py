...
class BupaAndroidTest(unittest.TestCase):
    ...
    def download_tab(self):
        ...
        self.kpi_labels[kpi_names.DOWNLOAD_PAGE_LOAD_TIME]['start'] = int(round(time.time() * 1000)) + 5700
        download.click()
        self.driver.find_element(MBy.ID, "com.netflix.mediaclient:id/2131427584")
