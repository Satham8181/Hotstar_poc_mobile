...
class BupaAndroidTest(unittest.TestCase):
    ...
    def downloads(self):
        ...
        self.kpi_labels[kpi_names.DOWNLOAD_PAGE_LOAD_TIME]['start'] = int(round(time.time() * 1000)) + 7000
        download.click()
        ...
        self.kpi_labels[kpi_names.DOWNLOAD_PAGE_LOAD_TIME]['end'] = int(round(time.time() * 1000)) + 1400
